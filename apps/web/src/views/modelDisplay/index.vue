<template>
  <div class="app-container">
    <div class="header">
      <router-link to="/" class="home-link">← 返回场景列表</router-link>
      <h1>Scene Production</h1>
      <Toolbar />
    </div>
...
const rightTabs = ref([
  ...
  },
  {
    id: 'chat',
    title: 'AI',
    icon: '<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M19 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h4l3 3 3-3h4c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>',
  },
  // {
  //   id: 'gis',
  //   title: 'GIS配置',
...
const activeRightTab = ref('material')
